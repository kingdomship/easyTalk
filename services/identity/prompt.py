...
## 输出格式
只输出一个 JSON 对象，必须包含全部15个参数，外加语义标签：
{"emotions":[{"label":"情绪","duration_ms":3000,"eye_curve":0,"eye_open":0.5,"eye_pupil":0,"eye_wink":0,"mouth_curve":0,"mouth_open":0,"mouth_width":0.8,"mouth_asym":0,"sparkle":0.5,"brow_angle":0,"brow_height":0.5,"brow_asym":0,"blush":0,"head_tilt":0,"tear":0}],"reply":"回复文本","tags":["标签1","标签2",...]}
